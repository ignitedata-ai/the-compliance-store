...
<?php if($display_footer_top || $display_footer_text) { ?>
	<footer <?php echo bridge_qode_get_inline_attr($footer_classes, 'class'); ?>>
...
if (is_user_logged_in()) {
	if ( is_page('search') ){ ?>
		<script type="text/javascript">
			jQuery( ".search-form" ).preventEmptySubmit();
		</script>
	<?php } ?>
	<?php /* ?>
	<!-- BEGIN PRIVY WIDGET CODE -->
	<script type='text/javascript'> var _d_site = _d_site || 'DFB93EF1067E817CE6F4B7C4'; </script>
