...
final class ExactMetrics_Report_SiteSpeed_Mobile extends ExactMetrics_Report {

	public $title;
	public $class = 'ExactMetrics_Report_SiteSpeed_Mobile';
	...
	public function __construct() {
		$this->title = __( 'Site-Speed Mobile', 'exactmetrics-premium' );
	...
	public function run_audit() {
		...
		$deleted = delete_option( 'exactmetrics_report_data_sitespeedmobile' );
