...
final class ExactMetrics_Report_Traffic_AI extends ExactMetrics_Report {

	public $class = 'ExactMetrics_Report_Traffic_AI';
	...
	public function __construct() {
		$this->title = __( 'Traffic AI', 'exactmetrics-premium' );
	...
	private function get_ai_source_icon( $source ) {
		...
		if ( file_exists( EXACTMETRICS_PLUGIN_DIR . 'pro/assets/img/ai/icon-' . $filename . '.svg' ) ) {
			return $filename;
		}
