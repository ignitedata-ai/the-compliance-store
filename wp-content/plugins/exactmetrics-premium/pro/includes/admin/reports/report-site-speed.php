 ...
 * @since 7.13.2
 */
final class ExactMetrics_Report_SiteSpeed extends ExactMetrics_Report {

	public $title;
	public $class = 'ExactMetrics_Report_SiteSpeed';
	...
	public function __construct() {
		$this->title = __( 'Site-Speed', 'exactmetrics-premium' );
	...
	public function run_audit() {
		...
		$deleted = delete_option( 'exactmetrics_report_data_sitespeed' );
