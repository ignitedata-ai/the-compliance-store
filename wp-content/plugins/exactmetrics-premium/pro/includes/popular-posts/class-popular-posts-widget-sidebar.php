...
class ExactMetrics_Popular_Posts_Widget_Sidebar extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html_x( 'Display popular posts.', 'Widget', 'exactmetrics-premium' ),
		);
		...
		// Load widget.
		parent::__construct( $widget_slug, esc_html_x( 'Popular Posts - ExactMetrics', 'Widget', 'exactmetrics-premium' ), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
		...
		if ( ! empty( $theme['styles']['label']['color'] ) ) {
			$this->color_input( 'label_color', _x( 'Label Color:', 'Widget', 'exactmetrics-premium' ), $instance );
		}
		if ( ! empty( $theme['styles']['label']['editable'] ) && ! empty( $theme['styles']['label']['text'] ) ) {
			$this->text_input( 'label_text', _x( 'Label Text:', 'Widget', 'exactmetrics-premium' ), $instance );
		}
		if ( ! empty( $theme['styles']['meta']['color'] ) ) {
			$this->color_input( 'meta_color', _x( 'Meta Color:', 'Widget', 'exactmetrics-premium' ), $instance );
		}
		if ( ! empty( $theme['styles']['meta']['size'] ) ) {
			$this->size_input( 'meta_size', _x( 'Meta Font Size:', 'Widget', 'exactmetrics-premium' ), $instance, $meta_font_sizes );
		}
		...
		if ( ! empty( $theme['styles']['comments']['color'] ) ) {
			$this->color_input( 'comments_color', _x( 'Comments Count Color:', 'Widget', 'exactmetrics-premium' ), $instance );
		}
		?>
		<p>

			<label class="exactmetrics-label-block">
				<?php echo esc_html( _x( 'Only Show Posts from These Categories:', 'Widget', 'exactmetrics-premium' ) ); ?>
			</label>
		...
		<p>
			<?php if ( ! empty( $theme['styles']['meta']['author'] ) ) { ?>
				<label class="exactmetrics-label-block">
					...
					<?php esc_html_e( 'Display Author', 'exactmetrics-premium' ); ?>
				</label>
			<?php } ?>
			<?php if ( ! empty( $theme['styles']['meta']['date'] ) ) { ?>
				<label class="exactmetrics-label-block">
					...
					<?php esc_html_e( 'Display Date', 'exactmetrics-premium' ); ?>
				</label>
			<?php } ?>
			<?php if ( ! empty( $theme['styles']['meta']['comments'] ) ) { ?>
				<label class="exactmetrics-label-block">
					...
					<?php esc_html_e( 'Display Comments', 'exactmetrics-premium' ); ?>
				</label>
			<?php } ?>
		</p>
		<?php
