	...
	public function build_inline_styles() {
		...
		foreach ( $themes as $theme_key => $theme_styles ) {
			...
			if ( ! empty( $theme_styles['border']['color2'] ) ) {
				$styles .= '.exactmetrics-inline-popular-posts.exactmetrics-popular-posts-styled.exactmetrics-inline-popular-posts-' . $theme_key . ' .exactmetrics-inline-popular-posts-border-2 {';
			...
			if ( ! empty( $theme_styles['icon'] ) ) {
				$styles .= '.exactmetrics-inline-popular-posts.exactmetrics-popular-posts-styled.exactmetrics-inline-popular-posts-' . $theme_key . ' .exactmetrics-inline-popular-posts-icon path {';
				...
				if ( ! empty( $theme_styles['icon']['background'] ) ) {
					$styles .= '.exactmetrics-inline-popular-posts.exactmetrics-popular-posts-styled.exactmetrics-inline-popular-posts-' . $theme_key . ' .exactmetrics-inline-popular-posts-icon {';
