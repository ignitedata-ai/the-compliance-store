 ...
 *
 */
class ExactMetrics_Divi_Button_Module extends ET_Builder_Module_Button {
	...
	public function init() {
		$this->name             = 'ExactMetrics Button';
		$this->plural           = 'ExactMetrics Buttons';
		$this->slug             = 'exactmetrics_divi_button_module';
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$custom_event_name = $this->props['exactmetrics_custom_event_name'];
