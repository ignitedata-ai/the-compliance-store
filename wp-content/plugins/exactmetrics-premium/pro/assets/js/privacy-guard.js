 ...
 * @return Object
 */
function ExactMetricsPrivacyGuardFilter( excludeURL ) {
	var locations = {
		page_location: ExactMetricsPrivacyGuard.filter( excludeURL.page_location ),
	};

	if ( excludeURL.page_referrer ) {
		locations.page_referrer = ExactMetricsPrivacyGuard.filter( excludeURL.page_referrer );
	}
