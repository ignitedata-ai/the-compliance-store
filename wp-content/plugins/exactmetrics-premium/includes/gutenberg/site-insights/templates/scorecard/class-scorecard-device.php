 ...
 *
 * Class ExactMetrics_SiteInsights_Template_Scorecard_Device
 */
class ExactMetrics_SiteInsights_Template_Scorecard_Device extends ExactMetrics_SiteInsights_Metric_Template {
	...
	protected function get_options() {
		...
		$title = __( 'Device Breakdown', 'exactmetrics-premium' );
