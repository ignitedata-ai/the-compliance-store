...
class ExactMetrics_SiteInsights_Template_Graph_Top10countries extends ExactMetrics_SiteInsights_Metric_Template {
	...
	protected function get_options() {
		...
		$title = __( 'Top 10 countries', 'exactmetrics-premium' );
		$series = array();
	...
	protected function get_amp_output() {
		...
		$output .= "<h3>" . __( 'Top Countries', 'exactmetrics-premium' ) . "</h3>";
		$output .= "</div>";
	...
	protected function get_amp_placeholder() {
		...
		$output .= "<h3>" . __( 'Top Countries', 'exactmetrics-premium' ) . "</h3>";
		$output .= "</div>";
		$output .= "<div class='exactmetrics-amp-no-data'>" . __( 'No country data available', 'exactmetrics-premium' ) . "</div>";
		$output .= "</div>";
	}
}