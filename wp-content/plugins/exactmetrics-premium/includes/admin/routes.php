...
class ExactMetrics_Rest_Routes {
	...
	public function get_addons( $is_onboarding ) {
		...
		$parsed_addons['easy_digital_downloads'] = array(
			...
			'excerpt'   => __( 'The best WordPress eCommerce plugin for selling digital downloads. Start selling eBooks, software, music, digital art, and more within minutes. Accept payments, manage subscriptions, advanced access control, and more.', 'exactmetrics-premium' ),
		...
		$parsed_addons['charitable'] = array(
			...
			'title'     => 'Charitable',
			'excerpt'   => __('Top-rated WordPress donation and fundraising plugin. Over 10,000+ non-profit organizations and website owners use Charitable to create fundraising campaigns and raise more money online.', 'exactmetrics-premium'),
		...
		$parsed_addons['wpcode'] = array(
			...
			'title'     => 'WPCode',
			'excerpt'   => __('Future proof your WordPress customizations with the most popular code snippet management plugin for WordPress. Trusted by over 1,500,000+ websites for easily adding code to WordPress right from the admin area.', 'exactmetrics-premium'),
		...
		$parsed_addons['duplicator'] = array(
			...
			'title'     => 'Duplicator',
			'excerpt'   => __('Leading WordPress backup & site migration plugin. Over 1,500,000+ smart website owners use Duplicator to make reliable and secure WordPress backups to protect their websites. It also makes website migration really easy.', 'exactmetrics-premium'),
		...
		$parsed_addons['affiliate-wp'] = array(
			...
			'title'     => 'AffiliateWP',
			'excerpt'   => __('The #1 affiliate management plugin for WordPress. Easily create an affiliate program for your eCommerce store or membership site within minutes and start growing your sales with the power of referral marketing.', 'exactmetrics-premium'),
		...
		$parsed_addons['wpsimplepay'] = array(
			...
			'title'     => 'WP Simple Pay',
			'excerpt'   => __('The #1 Stripe payments plugin for WordPress. Start accepting one-time and recurring payments on your WordPress site without setting up a shopping cart. No code required.', 'exactmetrics-premium'),
		...
		$parsed_addons['sugarcalendar'] = array(
			...
			'excerpt'   => __('A simple & powerful event calendar plugin for WordPress that comes with all the event management features including payments, scheduling, timezones, ticketing, recurring events, and more.', 'exactmetrics-premium'),
		...
		$parsed_addons['wpforms-lite'] = array(
			...
			'title'     => 'WPForms',
			'excerpt'   => __( 'The best drag & drop WordPress form builder. Easily create beautiful contact forms, surveys, payment forms, and more with our 1000+ form templates. Trusted by over 6 million websites as the best forms plugin.', 'exactmetrics-premium' ),
		...
		$parsed_addons['userfeedback-lite'] = array(
			...
			'title'     => 'UserFeedback',
			'excerpt'   => __( 'Ask visitors questions about how they use your website or what features can make you more money.', 'exactmetrics-premium' ),
		...
		$parsed_addons['aioseo'] = array(
			...
			'title'     => 'AIOSEO',
			'excerpt'   => __( 'The original WordPress SEO plugin and toolkit that improves your website’s search rankings. Comes with all the SEO features like Local SEO, WooCommerce SEO, sitemaps, SEO optimizer, schema, and more.', 'exactmetrics-premium' ),
		...
		$parsed_addons['funnelkit-stripe-woo-payment-gateway'] = array(
			...
			'excerpt'   => __( 'Stripe Payment Gateway for WooCommerce is an integrated solution that lets you accept payments on your online store for web and mobile.', 'exactmetrics-premium' ),
		...
		$parsed_addons['wp-mail-smtp'] = array(
			...
			'title'     => 'WP Mail SMTP',
			'excerpt'   => __( 'Improve your WordPress email deliverability and make sure that your website emails reach user’s inbox with the #1 SMTP plugin for WordPress. Over 3 million websites use it to fix WordPress email issues.', 'exactmetrics-premium' ),
		...
		$parsed_addons['coming-soon'] = array(
			...
			'title'     => 'SeedProd',
			'excerpt'   => __( 'The fastest drag & drop landing page builder for WordPress. Create custom landing pages without writing code, connect them with your CRM, collect subscribers, and grow your audience. Trusted by 1 million sites.', 'exactmetrics-premium' ),
		...
		$parsed_addons['rafflepress'] = array(
			...
			'title'     => 'RafflePress',
			'excerpt'   => __( 'Turn your website visitors into brand ambassadors! Easily grow your email list, website traffic, and social media followers with the most powerful giveaways & contests plugin for WordPress.', 'exactmetrics-premium' ),
		...
		$parsed_addons['trustpulse'] = array(
			...
			'title'     => 'TrustPulse',
			'excerpt'   => __( 'Boost your sales and conversions by up to 15% with real-time social proof notifications. TrustPulse helps you show live user activity and purchases to help convince other users to purchase.', 'exactmetrics-premium' ),
		...
		$parsed_addons['searchwp'] = array(
			...
			'title'     => 'SearchWP',
			'excerpt'   => __('The most advanced WordPress search plugin. Customize your WordPress search algorithm, reorder search results, track search metrics, and everything you need to leverage search to grow your business.', 'exactmetrics-premium'),
		...
		$parsed_addons['instagram-feed'] = array(
			...
			'excerpt'   => __( 'Easily display Instagram content on your WordPress site without writing any code. Comes with multiple templates, ability to show content from multiple accounts, hashtags, and more. Trusted by 1 million websites.', 'exactmetrics-premium' ),
		...
		$parsed_addons['custom-facebook-feed'] = array(
			...
			'excerpt'   => __( 'Easily display Facebook content on your WordPress site without writing any code. Comes with multiple templates, ability to embed albums, group content, reviews, live videos, comments, and reactions.', 'exactmetrics-premium' ),
		...
		$parsed_addons['smash-balloon-youtube'] = array(
			...
			'excerpt'   => __('Easily display YouTube videos on your WordPress site without writing any code. Comes with multiple layouts, ability to embed live streams, video filtering, ability to combine multiple channel videos, and more.', 'exactmetrics-premium'),
		...
		$parsed_addons['smash-balloon-twitter'] = array(
			...
			'excerpt'   => __('Easily display Twitter content in WordPress without writing any code. Comes with multiple layouts, ability to combine multiple Twitter feeds, Twitter card support, tweet moderation, and more.', 'exactmetrics-premium'),
		...
		$parsed_addons['pushengage'] = array(
			...
			'title'     => 'PushEngage',
			'excerpt'   => __('Connect with your visitors after they leave your website with the leading web push notification software. Over 10,000+ businesses worldwide use PushEngage to send 15 billion notifications each month.', 'exactmetrics-premium'),
		...
		$parsed_addons['uncanny-automator'] = array(
			...
			'excerpt'   => __('Automate everything with the #1 no-code Automation tool for WordPress.', 'exactmetrics-premium'),
		...
		$parsed_addons['pretty-link'] = array(
			...
			'icon'      => '',
			'title'     => 'Pretty Links',
			'excerpt'   => __( 'Pretty Links helps you shrink, beautify, track, manage and share any URL on or off of your WordPress website. Create links that look how you want using your own domain name!', 'exactmetrics-premium' ),
		...
		$parsed_addons['stripe'] = array(
			...
			'title'     => 'WP Simple Pay',
			'excerpt'   => __( 'Start accepting one-time and recurring payments on your WordPress site without setting up a shopping cart. No code required.', 'exactmetrics-premium' ),
			'installed' => array_key_exists( 'stripe/stripe-checkout.php', $installed_plugins ),
			'basename'  => 'stripe/stripe-checkout.php',
			'slug'      => 'stripe',
		...
		if ( function_exists( 'WC' ) ) {
			...
			$parsed_addons['advancedcoupons'] = array(
				...
				'excerpt'   => __( 'Advanced Coupons for WooCommerce (Free Version) gives WooCommerce store owners extra coupon features so they can market their stores better.', 'exactmetrics-premium' ),
		...
		$parsed_addons['userfeedback-lite'] = array(
			...
			'title'     => 'UserFeedback',
			'excerpt'   => __( 'See what your analytics software isn’t telling you with powerful UserFeedback surveys.', 'exactmetrics-premium' ),
			'installed' => array_key_exists( 'userfeedback-lite/userfeedback.php', $installed_plugins ) || array_key_exists( 'userfeedback/userfeedback.php', $installed_plugins ),
			'basename'  => 'userfeedback-lite/userfeedback.php',
			'slug'      => 'userfeedback-lite',
		...
		$parsed_addons['optinmonster'] = array(
			...
			'title'     => 'OptinMonster',
			'excerpt'   => __( 'Instantly get more subscribers, leads, and sales with the #1 conversion optimization toolkit. Create high converting popups, announcement bars, spin a wheel, and more with smart targeting and personalization.', 'exactmetrics-premium' ),
	...
	public function update_manual_v4() {
		...
		if ( $manual_v4_code && $manual_v4_code_old && $manual_v4_code_old === $manual_v4_code ) {
			...
			wp_send_json_error( array(
				...
				'error'    => sprintf(
					__( 'Oops! Please enter a valid Google Analytics 4 Measurement ID. %1$sLearn how to find your Measurement ID%2$s.', 'exactmetrics-premium' ),
	...
	public function handle_settings_import() {
		...
		if ( 'json' !== $extension ) {
			wp_send_json_error( array(
				'message' => esc_html__( 'Please upload a valid .json file', 'exactmetrics-premium' ),
			) );
		}
		...
		if ( empty( $file ) ) {
			wp_send_json_error( array(
				'message' => esc_html__( 'Please select a valid file to upload.', 'exactmetrics-premium' ),
			) );
		}
	...
	public function get_report_data() {
		...
		if ( ! current_user_can( 'exactmetrics_view_dashboard' ) ) {
			// Translators: link tag starts with url, link tag ends.
			$message = sprintf(
				esc_html__( 'Oops! You don not have permissions to view ExactMetrics reporting. Please check with your site administrator that your role is included in the ExactMetrics permissions settings. %1$sClick here for more information%2$s.', 'exactmetrics-premium' ),
		...
		if ( exactmetrics_is_pro_version() ) {
			if ( ! ExactMetrics()->license->is_site_licensed() && ! ExactMetrics()->license->is_network_licensed() ) {
				...
				$message = sprintf(
					esc_html__( 'Oops! You cannot view ExactMetrics reports because you are not licensed. Please try again in a few minutes. If the issue continues, please %1$scontact our support%2$s team.', 'exactmetrics-premium' ),
					'<a target="_blank" href="' . exactmetrics_get_url( 'notice', 'cannot-view-reports', 'https://www.exactmetrics.com/my-account/support/' ) . '">',
					'</a>'
				);
				wp_send_json_error( array(
					'message' => $message,
					'footer'  => '<a href="' . $settings_page . '">' . __( 'Add your license', 'exactmetrics-premium' ) . '</a>',
				) );
				...
				// Translators: Support link tag starts with url and Support link tag ends.
				$message = sprintf(
					esc_html__( 'Oops! We had a problem due to a license key error. Please try again in a few minutes. If the problem persists, please %1$scontact our support%2$s team.', 'exactmetrics-premium' ),
					'<a target="_blank" href="' . exactmetrics_get_url( 'notice', 'cannot-view-reports', 'https://www.exactmetrics.com/my-account/support/' ) . '">',
					'</a>'
				);
				wp_send_json_error( array( 'message' => $message ) );
		...
		if ( ! $site_auth && ! $ms_auth ) {
			...
			$message = sprintf(
				esc_html__( 'You need to authenticate into ExactMetrics before viewing reports. Please run our %1$ssetup wizard%2$s.', 'exactmetrics-premium' ),
				'<a href="' . esc_url( $url ) . '">',
				'</a>'
			);
			wp_send_json_error( array( 'message' => $message ) );
		...
		if ( empty( $report_name ) ) {
			// Translators: Support link tag starts with url and Support link tag ends.
			$message = sprintf(
				esc_html__( 'Oops! We ran into a problem displaying this report. Please %1$scontact our support%2$s team if this issue persists.', 'exactmetrics-premium' ),
		...
		// Translators: Support link tag starts with url and Support link tag ends.
		$message = sprintf(
			esc_html__( 'Oops! We encountered an error while generating your reports. Please wait a few minutes and try again. If the issue persists, please %1$scontact our support%2$s team.', 'exactmetrics-premium' ),
	...
	public function install_plugin() {
		...
		if ( ! exactmetrics_can_install_plugins() ) {
			wp_send_json( array(
				'error' => esc_html__( 'Oops! You are not allowed to install plugins. Please contact your website administrator for further assistance.', 'exactmetrics-premium' ),
			) );
		}
		...
		if ( is_dir( WP_PLUGIN_DIR . '/' . $slug ) ) {
			wp_send_json_success(__( 'Plugin already installed.', 'exactmetrics-premium' ));
		}
	...
	public function get_posts() {
		...
		if ( in_array( $post_type, array( 'page', 'any' ), true ) ) {
			...
			if ( ! $homepage ) {
				$array[] = array(
					'id'    => - 1,
					'title' => __( 'Homepage', 'exactmetrics-premium' ),
				);
			}
		}
	...
	public function check_popular_posts_report() {
		...
		if ( ! current_user_can( 'exactmetrics_view_dashboard' ) ) {
			...
			$message = sprintf(
				esc_html__( 'Oops! You don not have permissions to view or access Popular Posts. Please check with your site administrator that your role is included in the ExactMetrics permissions settings. %1$sClick here for more information%2$s.', 'exactmetrics-premium' ),
		...
		if ( exactmetrics_is_pro_version() ) {
			if ( ! ExactMetrics()->license->is_site_licensed() && ! ExactMetrics()->license->is_network_licensed() ) {
				...
				$message = sprintf(
					esc_html__( 'Oops! We could not find a valid license key for ExactMetrics. Please %1$senter a valid license key%2$s to view this report.', 'exactmetrics-premium' ),
					'<a href="' . esc_url( $url ) . '">',
					'</a>'
				);
				wp_send_json_error( array(
				...
				$message = sprintf(
					esc_html__( 'Oops! We could not find a valid license key. Please enter a valid license key to view this report. You can find your license by logging into your %1$sExactMetrics account%2$s.', 'exactmetrics-premium' ),
		...
		if ( ! $site_auth && ! $ms_auth ) {
			...
			$message = sprintf(
				esc_html__( 'You need to authenticate into ExactMetrics before viewing reports. Please complete the setup by going through our %1$ssetup wizard%2$s.', 'exactmetrics-premium' ),
				'<a href="' . esc_url( $url ) . '">',
				'</a>'
			);
			wp_send_json_error( array( 'message' => $message ) );
		...
		// Translators: Support link tag starts with url and Support link tag ends.
		$message = sprintf(
			__( 'Oops! We encountered an error while generating your reports. Please wait a few minutes and try again. If the issue persists, please %1$scontact our support%2$s team.', 'exactmetrics-premium' ),
			'<a target="_blank" href="' . exactmetrics_get_url( 'notice', 'cannot-generate-reports', 'https://www.exactmetrics.com/my-account/support/' ) . '">',
			'</a>'
		);
		wp_send_json_error( array( 'message' => $message ) );
