...
class ExactMetrics_Site_Notes_DB_Base
{
	...
	public function insert_default_categories()
	{
		...
		$categories = array(
			array(
				'name' => __('Website Updates', 'exactmetrics-premium'),
				'background_color' => '#F072B2'
			),
			array(
				'name' => __('Blog Post', 'exactmetrics-premium'),
				'background_color' => '#8D87E5'
			),
			array(
				'name' => __('Promotion', 'exactmetrics-premium'),
	...
	{
		if (empty($data['note'])) {
			return new WP_Error(400, __('Your Site Note Cannot be Empty', 'exactmetrics-premium'));
		}
		$note_post = array(
	...
	public function get($post_id)
	{
		...
		if (!$post) {
			return new WP_Error(400, __('Note not found', 'exactmetrics-premium'));
		}
