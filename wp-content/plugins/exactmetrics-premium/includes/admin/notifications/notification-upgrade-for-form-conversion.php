...
final class ExactMetrics_Notification_Upgrade_For_Form_Conversion extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		$notification['title'] = __( 'Easily Track Form Conversions', 'exactmetrics-premium' );
		/* translators: Placeholders add a link to the settings page. */
		$notification['content'] = sprintf( __( 'Track your website\'s form conversion rates by upgrading to %1$sExactMetrics Pro%2$s.', 'exactmetrics-premium' ), '<a href="' . $this->get_upgrade_url() . '" target="_blank">', '</a>' );
