...
class ExactMetrics_Notification_Multiple_Gtags extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		if ( is_array( $response ) ) {
			...
			$notification['title']   = __( "Multiple Google Analytics Tags Found", "exactmetrics-premium" );
			$notification['content'] = __( "ExactMetrics has detected multiple analytics tags on your website. Please disable the other plugin to ensure accurate tracking.", 'exactmetrics-premium' );
