...
final class ExactMetrics_Notification_Upgrade_For_Post_Templates extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['content'] = __( 'Upgrade ExactMetrics Pro and use up to 20+ Popular Post templates to help improve engagement and interaction on your site.', 'exactmetrics-premium' );
