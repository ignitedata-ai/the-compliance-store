...
final class ExactMetrics_Notification_Upgrade_For_Custom_Dimensions extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		$notification['title'] = __( 'Upgrade to ExactMetrics Pro', 'exactmetrics-premium' );
		// Translators: upgrade for form conversion notification content
		$notification['content'] = __( 'Upgrade to enable Custom Dimensions. Track logged in users, determine when is your best time to post, measure if your SEO strategy is working, and find your most popular author.', 'exactmetrics-premium' );
		$notification['btns']    = array(
			"get_exactmetrics_pro" => array(
				'url'         => $this->get_upgrade_url(),
				'text'        => __( 'Get ExactMetrics Pro', 'exactmetrics-premium' ),
				'is_external' => true,
			),
		);
