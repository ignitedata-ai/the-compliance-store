...
final class ExactMetrics_Notification_Upgrade_To_Pro_High_Traffic extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['content'] = __( 'Upgrade to ExactMetrics Pro to take advantage of advanced Google Analytics settings, unlock advanced insights, utilize Custom Dimensions, and more.', 'exactmetrics-premium' );
