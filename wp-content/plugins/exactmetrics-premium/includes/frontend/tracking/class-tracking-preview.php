...
class ExactMetrics_Tracking_Preview extends ExactMetrics_Tracking_Abstract {
	...
	public function frontend_output() {
		...
		$output .= '<!-- ' . esc_html__( "You are currently in a preview window. ExactMetrics doesn't track preview window traffic to avoid false visit reports.", 'exactmetrics-premium' ) . ' -->';
