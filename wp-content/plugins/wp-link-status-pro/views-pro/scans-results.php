...
class WPLNST_Views_Pro_Scans_Results extends WPLNST_Views_Scans_Results {
	...
	private function filters_advanced() {
		...
		$export_button = '<a class="export-links" href="'.$GLOBALS['file_url'].'">Export Results</a>';
		...
		$anchor = '<div class="wplnst-results-filters-advanced-row wplnst-clearfix">'.$anchor.$anchor_select.$export_button.$search_button.
		'</div>';
