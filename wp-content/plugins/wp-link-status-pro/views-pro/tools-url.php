...
class WPLNST_Views_Pro_Tools_URL {
	...
	public static function display($args) {
		...
		?><form id="wplnst-tu-form" method="post" action="<?php echo esc_url($action_url); ?>"
			 data-confirm="<?php esc_attr_e('WordPress database will be updated, press Ok to continue', 'wplnst'); ?>"
			 data-nolinks="<?php esc_attr_e('Sorry, no links detected. Please enter some URLs.', 'wplnst'); ?>"
			 data-label-processing="<?php esc_attr_e('Processing', 'wplnst'); ?>"
			 data-label-updating="<?php esc_attr_e('Updating database', 'wplnst'); ?>"
			 data-label-testmode="<?php esc_attr_e('Test mode, no database changes', 'wplnst'); ?>"
			 data-label-cancel="<?php esc_attr_e('Cancel', 'wplnst'); ?>"
			 data-label-nofoundentries="<?php esc_attr_e('No found entries', 'wplnst'); ?>"
			 data-label-cancelling="<?php esc_attr_e('Cancelling', 'wplnst'); ?>"
			 data-label-cancelled="<?php esc_attr_e('Cancelled', 'wplnst'); ?>"
			 data-label-finished="<?php esc_attr_e('Finished', 'wplnst'); ?>"
			 data-label-processed="<?php esc_attr_e('Processed', 'wplnst'); ?>"
			 data-label-of="<?php esc_attr_e('of', 'wplnst'); ?>"
			 data-label-links="<?php esc_attr_e('links', 'wplnst'); ?>"
			 data-label-server-comm-error="<?php esc_attr_e(WPLNST_Core_Text::get_text('server_comm_error')); ?>"
			 data-label-backtotheform="<?php esc_attr_e('Back to the form', 'wplnst'); ?>">
