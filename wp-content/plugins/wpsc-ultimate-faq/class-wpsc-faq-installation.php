...
if ( ! class_exists( 'WPSC_FAQ_Installation' ) ) :

	final class WPSC_FAQ_Installation {
		...
		public static function init() {
			...
			if ( self::$is_upgrade ) {
				...
				define( 'WPSC_FAQ_INSTALLING', true );

				// Do not allow parallel process to run.
				if ( 'yes' === get_transient( 'wpsc_faq_installing' ) ) {
					return;
				}

				// Set transient.
				set_transient( 'wpsc_faq_installing', 'yes', MINUTE_IN_SECONDS * 10 );
				...
				// Delete transient.
				delete_transient( 'wpsc_faq_installing' );
			}

			// activation functionality.
			register_activation_hook( WPSC_FAQ_PLUGIN_FILE, array( __CLASS__, 'activate' ) );

			// Deactivate functionality.
			register_deactivation_hook( WPSC_FAQ_PLUGIN_FILE, array( __CLASS__, 'deactivate' ) );
		}
		...
		public static function get_current_version() {
			...
			self::$current_version = get_option( 'wpsc_ultfaq_current_version', 0 );
		}
		...
		public static function check_upgrade() {
			...
			if ( self::$current_version != WPSC_FAQ_VERSION ) {
		...
		public static function initial_setup() {
			...
			update_option( 'wpsc-faq-settings', array( 'faq' => '' ) );
		}
		...
		public static function set_upgrade_complete() {
			...
			update_option( 'wpsc_ultfaq_current_version', WPSC_FAQ_VERSION );
			self::$current_version = WPSC_FAQ_VERSION;
		...
		public static function deactivate() {
			...
			do_action( 'wpsc_faq_deactivate' );
		}
	}
endif;

WPSC_FAQ_Installation::init();
