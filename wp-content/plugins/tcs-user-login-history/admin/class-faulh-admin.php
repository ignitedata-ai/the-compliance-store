...
if (!class_exists('Faulh_Admin')) {
   ...
   $url = admin_url();
        ...
        public function admin_init() {
            if (! 
                    (
                        ...
                        current_user_can('account_manager') ||
                        current_user_can('backend-admin')
                    )
                ) {
                return;
            }
        ...
        public function plugin_menu() {
            ...
            $hook = add_submenu_page( 'views-reports', __( 'Users Login History', 'reports' ), __( 'Users Login History', 'reports' ), 'manage_options', $menu_slug, array($this, 'render_list_table') );
