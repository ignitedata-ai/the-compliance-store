                        ...
                        if ( $row != 1 ) {
                            ...
                            if ( !$user_id && $user_email == false ) {
                                ...
                                $subscribers_array = array(
                                    'subscriber_-_corporate',
                                    'subscriber_-_admin_facility',
                                    'business'
                                );
                                if (in_array($new_record['capabilities'], $subscribers_array)) {
                                    if (isset($new_record['company']) && !empty($new_record['company'])) {
                                        $unique_company = $new_record['company'].' - '.$user_id;
                                        update_user_meta($user_id, 'unique_company', $unique_company);
                                    }
                                }
                                if($new_record['capabilities'] == 'subscriber_-_facility_user' && !empty($new_record['corporate_facility'])) {
                                    $get_admin_facility = get_users(array(
                                        'role' => 'subscriber_-_admin_facility',
                                        'meta_key'     => 'unique_company',
                                ...
                                elseif ($new_record['capabilities'] == 'subscriber_-_admin_facility' && !empty($new_record['corporate_facility'])) {
                                ...
                                if ($new_record['capabilities'] !== 'business' && !empty($new_record['business'])) {
                                    $get_users = get_users(array(
                                        'role' => 'business',
                                        'meta_key'     => 'unique_company',
