...
if ( ! class_exists( 'WPSC_FAQ' ) ) :

	final class WPSC_FAQ {
		...
		public static function init() {
			...
			if ( defined( 'WPSC_DB_UPGRADING' ) || defined( 'WPSC_FAQ_INSTALLING' ) ) {
				return;
			}
		...
		public static function define_constants() {
			...
			self::define( 'WPSC_FAQ_PLUGIN_FILE', __FILE__ );
			self::define( 'WPSC_FAQ_ABSPATH', __DIR__ . '/' );
			self::define( 'WPSC_FAQ_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
		...
		private static function load_files() {
			...
			// Load installation.
			include_once WPSC_FAQ_ABSPATH . 'class-wpsc-faq-installation.php';
			...
			// Load common classes.
			foreach ( glob( WPSC_FAQ_ABSPATH . 'includes/*.php' ) as $filename ) {
