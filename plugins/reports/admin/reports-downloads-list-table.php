...
class downloads_List_Table extends WP_List_Table {
    ...
    function column_title($item) {
        ...
        $actions = array(
            ...
            'delete' => sprintf('<a href="?page=download-reports&action=%s&download=%s&row_id=%s&_wpnonce=%s" onclick="return confirm(\'Are you sure you want to delete this entry?\')">' . __('Delete', 'reports') . '</a>', 'delete', $item['ID'], $item['row_id'], $delete_log_nonce),
            'view-counts' => sprintf('<a href="' . admin_url('admin.php?page=download-reports&action=reports-logs-by-download&document_id=' . $item['ID'] ). '">' . __('View Counts', 'reports') . '</a>'),
        );
    ...
    function prepare_items() {
        ...
        if(isset($_REQUEST['document_id']) && !empty($_REQUEST['document_id'])){
            foreach ($data_results as $data_result) {
                ...
                $counts = '<a href="' . admin_url('admin.php?page=download-reports&action=reports-logs-by-download&document_id=' . $data_result->post_id ). '">' . $total_downloads . '</a>';
