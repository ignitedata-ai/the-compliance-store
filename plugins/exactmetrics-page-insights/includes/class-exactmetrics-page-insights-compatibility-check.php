 ...
 * @since 1.3.4
 */
class ExactMetrics_Page_Insights_Compatibility_Check {
	/**
	 * Holds singleton instance
	 *
	 * @since 1.3.4
	 * @var ExactMetrics_Page_Insights_Compatibility_Check
	 */
	 ...
	 *
	 * @return ExactMetrics_Page_Insights_Compatibility_Check
	 * @since 1.3.4
	 */
	...
	public function display_php_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your current version of PHP does not meet the minimum required version %1$s%2$s%3$s or newer to run ExactMetrics Page Insights Addon properly. For information on how to upgrade your PHP version, contact your web host. %4$sClick here to return to the Dashboard%5$s.', 'exactmetrics-page-insights' ),
					'<strong>',
	...
	public function display_wp_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your WordPress version is not %1$s%2$s%3$s or newer. Please update your WordPress version and then activate ExactMetrics Page Insights Addon. For help on how to update your WordPress %4$sclick here%5$s.', 'exactmetrics-page-insights' ),
					'<strong>',
