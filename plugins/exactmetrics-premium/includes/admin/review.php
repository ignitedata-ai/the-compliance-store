		...
		<div class="notice notice-info is-dismissible exactmetrics-review-notice">
			<div class="exactmetrics-review-step">
				<p>
					...
					echo wp_kses(
						sprintf(
							__( 'Hey - we noticed you\'ve been using %1$s for a while - that\'s great! Could you do us a BIG favor and give it a 5-star review on WordPress to help us spread the word and boost our motivation?', 'exactmetrics-premium' ),
				...
				<p>
					<a
						href="https://wordpress.org/support/plugin/exactmetrics-premium/reviews/?filter=5#new-post"
						   class="exactmetrics-dismiss-review-notice exactmetrics-review-out"
						target="_blank"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'Ok, you deserve it', 'exactmetrics-premium' ); ?>
					</a>
					<br>
					<a
						href="#"
						class="exactmetrics-dismiss-review-notice exactmetrics-review-later"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'Nope, maybe later', 'exactmetrics-premium' ); ?>
					</a>
					<br>
					<a
						href="#"
						class="exactmetrics-dismiss-review-notice"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'I already did', 'exactmetrics-premium' ); ?>
					</a>
				</p>
			</div>
		</div>
