...
class ExactMetrics_WP_Site_Health {
	...
	public function add_tests( $tests ) {
		$tests['direct']['exactmetrics_dual_tracking'] = array(
			'label' => __( 'ExactMetrics Dual Tracking', 'exactmetrics-premium' ),
	...
	public function test_dual_tracking() {
		...
		return array(
			'label'       => __( 'Enable Google Analytics 4', 'exactmetrics-premium' ),
			'status'      => 'critical',
			'badge'       => array(
				'label' => __( 'ExactMetrics', 'exactmetrics-premium' ),
				'color' => 'blue',
			),
			'description' => __( 'Starting July 1, 2023, Google\'s Universal Analytics (GA3) will not accept any new traffic or event data. Upgrade to Google Analytics 4 today to be prepared for the sunset.', 'exactmetrics-premium' ),
			'actions'     => sprintf(
				'<p><a href="%s" target="_blank" rel="noopener noreferrer">%s</a></p>',
				$setup_link,
				__( 'Set Up Dual Tracking', 'exactmetrics-premium' )
			),
