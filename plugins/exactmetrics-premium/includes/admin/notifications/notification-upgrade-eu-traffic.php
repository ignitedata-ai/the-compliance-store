...
final class ExactMetrics_Notification_Upgrade_EU_Traffic extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['title']   = __( 'Help Your Site Become GDPR Compliant', 'exactmetrics-premium' );
		$notification['content'] = __( 'Your site is receiving traffic from the EU. Help ensure your site is more compliant with GDPR by upgrading to ExactMetrics Pro and enable our EU Privacy addon.', 'exactmetrics-premium' );
