...
final class ExactMetrics_Notification_Upgrade_To_Pro_Five_Hundred_Session extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['title'] = __( "Congrats! You've hit 500 monthly sessions!", 'exactmetrics-premium' );
		// Translators: upgrade to pro notification content
		$notification['content'] = __( 'Folks like you who upgrade to ExactMetrics Pro get access to advanced reporting, powerful integrations to help you grow even more!', 'exactmetrics-premium' );
