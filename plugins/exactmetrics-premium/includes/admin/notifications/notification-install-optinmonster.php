...
final class ExactMetrics_Notification_Install_OptinMonster extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		if ( $sessions > 1000 && ! $om_plugin_active ) {
			$notification['title']   = __( 'Increase Engagement on Your Site', 'exactmetrics-premium' );
			$notification['content'] = __( 'Get more leads and subscribers from your traffic by creating engaging campaigns with OptinMonster.', 'exactmetrics-premium' );
