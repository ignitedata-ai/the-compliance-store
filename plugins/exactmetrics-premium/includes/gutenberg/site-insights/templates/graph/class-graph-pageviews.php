...
class ExactMetrics_SiteInsights_Template_Graph_Pageviews extends ExactMetrics_SiteInsights_Metric_Template {
	...
	protected function get_amp_output() {
		...
		$output .= '<h3>' . esc_html__( 'Pageviews', 'exactmetrics-premium' ) . '</h3>';
		...
		$output .= '<h4>' . esc_html__( 'Last 7 days', 'exactmetrics-premium' ) . '</h4>';
		$output .= '<ul>';
	...
	private function get_amp_placeholder() {
		return sprintf(
			...
			esc_html__( 'No pageviews data available', 'exactmetrics-premium' )
		);
	}
	...
	protected function get_options() {
		...
		$title = __( 'Page views', 'exactmetrics-premium' );
