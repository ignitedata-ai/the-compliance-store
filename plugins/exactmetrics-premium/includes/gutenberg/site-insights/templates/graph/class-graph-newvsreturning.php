...
class ExactMetrics_SiteInsights_Template_Graph_Newvsreturning extends ExactMetrics_SiteInsights_Metric_Template {
	...
	protected function get_amp_output() {
		...
		$html .= "<div class='exactmetrics-amp-chart-title'>" . __( 'New vs Returning', 'exactmetrics-premium' ) . "</div>";
		...
		$html .= "<div class='exactmetrics-amp-donut-label'>" . __( 'New Visitors', 'exactmetrics-premium' ) . "</div>";
		...
		$html .= "<div class='exactmetrics-amp-donut-label'>" . __( 'Returning Visitors', 'exactmetrics-premium' ) . "</div>";
	...
	protected function get_options() {
		...
		$title = __( 'New vs Returning', 'exactmetrics-premium' );
		...
		$options = array(
			...
			'labels' => array(
				__( 'New Visitors', 'exactmetrics-premium' ),
				__( 'Returning Visitors', 'exactmetrics-premium' ),
			),
			'plotOptions' => array(
				'plotOptions' => array(
					'pie' => array(
