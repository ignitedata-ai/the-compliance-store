...
function exactmetrics_get_country_list( $translated = false ) {
	if ( $translated ) {
		$countries = array(
			''   => '',
			'US' => __( 'United States', 'exactmetrics-premium' ),
			'CA' => __( 'Canada', 'exactmetrics-premium' ),
			'GB' => __( 'United Kingdom', 'exactmetrics-premium' ),
			'AF' => __( 'Afghanistan', 'exactmetrics-premium' ),
			'AX' => __( '&#197;land Islands', 'exactmetrics-premium' ),
			'AL' => __( 'Albania', 'exactmetrics-premium' ),
			'DZ' => __( 'Algeria', 'exactmetrics-premium' ),
			'AS' => __( 'American Samoa', 'exactmetrics-premium' ),
			'AD' => __( 'Andorra', 'exactmetrics-premium' ),
			'AO' => __( 'Angola', 'exactmetrics-premium' ),
			'AI' => __( 'Anguilla', 'exactmetrics-premium' ),
			'AQ' => __( 'Antarctica', 'exactmetrics-premium' ),
			'AG' => __( 'Antigua and Barbuda', 'exactmetrics-premium' ),
			'AR' => __( 'Argentina', 'exactmetrics-premium' ),
			'AM' => __( 'Armenia', 'exactmetrics-premium' ),
			'AW' => __( 'Aruba', 'exactmetrics-premium' ),
			'AU' => __( 'Australia', 'exactmetrics-premium' ),
			'AT' => __( 'Austria', 'exactmetrics-premium' ),
			'AZ' => __( 'Azerbaijan', 'exactmetrics-premium' ),
			'BS' => __( 'Bahamas', 'exactmetrics-premium' ),
			'BH' => __( 'Bahrain', 'exactmetrics-premium' ),
			'BD' => __( 'Bangladesh', 'exactmetrics-premium' ),
			'BB' => __( 'Barbados', 'exactmetrics-premium' ),
			'BY' => __( 'Belarus', 'exactmetrics-premium' ),
			'BE' => __( 'Belgium', 'exactmetrics-premium' ),
			'BZ' => __( 'Belize', 'exactmetrics-premium' ),
			'BJ' => __( 'Benin', 'exactmetrics-premium' ),
			'BM' => __( 'Bermuda', 'exactmetrics-premium' ),
			'BT' => __( 'Bhutan', 'exactmetrics-premium' ),
			'BO' => __( 'Bolivia', 'exactmetrics-premium' ),
			'BQ' => __( 'Bonaire, Saint Eustatius and Saba', 'exactmetrics-premium' ),
			'BA' => __( 'Bosnia and Herzegovina', 'exactmetrics-premium' ),
			'BW' => __( 'Botswana', 'exactmetrics-premium' ),
			'BV' => __( 'Bouvet Island', 'exactmetrics-premium' ),
			'BR' => __( 'Brazil', 'exactmetrics-premium' ),
			'IO' => __( 'British Indian Ocean Territory', 'exactmetrics-premium' ),
			'BN' => __( 'Brunei Darrussalam', 'exactmetrics-premium' ),
			'BG' => __( 'Bulgaria', 'exactmetrics-premium' ),
			'BF' => __( 'Burkina Faso', 'exactmetrics-premium' ),
			'BI' => __( 'Burundi', 'exactmetrics-premium' ),
			'KH' => __( 'Cambodia', 'exactmetrics-premium' ),
			'CM' => __( 'Cameroon', 'exactmetrics-premium' ),
			'CV' => __( 'Cape Verde', 'exactmetrics-premium' ),
			'KY' => __( 'Cayman Islands', 'exactmetrics-premium' ),
			'CF' => __( 'Central African Republic', 'exactmetrics-premium' ),
			'TD' => __( 'Chad', 'exactmetrics-premium' ),
			'CL' => __( 'Chile', 'exactmetrics-premium' ),
			'CN' => __( 'China', 'exactmetrics-premium' ),
			'CX' => __( 'Christmas Island', 'exactmetrics-premium' ),
			'CC' => __( 'Cocos Islands', 'exactmetrics-premium' ),
			'CO' => __( 'Colombia', 'exactmetrics-premium' ),
			'KM' => __( 'Comoros', 'exactmetrics-premium' ),
			'CD' => __( 'Congo, Democratic People\'s Republic', 'exactmetrics-premium' ),
			'CG' => __( 'Congo, Republic of', 'exactmetrics-premium' ),
			'CK' => __( 'Cook Islands', 'exactmetrics-premium' ),
			'CR' => __( 'Costa Rica', 'exactmetrics-premium' ),
			'CI' => __( 'Cote d\'Ivoire', 'exactmetrics-premium' ),
			'HR' => __( 'Croatia/Hrvatska', 'exactmetrics-premium' ),
			'CU' => __( 'Cuba', 'exactmetrics-premium' ),
			'CW' => __( 'Cura&Ccedil;ao', 'exactmetrics-premium' ),
			'CY' => __( 'Cyprus', 'exactmetrics-premium' ),
			'CZ' => __( 'Czechia', 'exactmetrics-premium' ),
			'DK' => __( 'Denmark', 'exactmetrics-premium' ),
			'DJ' => __( 'Djibouti', 'exactmetrics-premium' ),
			'DM' => __( 'Dominica', 'exactmetrics-premium' ),
			'DO' => __( 'Dominican Republic', 'exactmetrics-premium' ),
			'TP' => __( 'East Timor', 'exactmetrics-premium' ),
			'EC' => __( 'Ecuador', 'exactmetrics-premium' ),
			'EG' => __( 'Egypt', 'exactmetrics-premium' ),
			'GQ' => __( 'Equatorial Guinea', 'exactmetrics-premium' ),
			'SV' => __( 'El Salvador', 'exactmetrics-premium' ),
			'ER' => __( 'Eritrea', 'exactmetrics-premium' ),
			'EE' => __( 'Estonia', 'exactmetrics-premium' ),
			'ET' => __( 'Ethiopia', 'exactmetrics-premium' ),
			'FK' => __( 'Falkland Islands', 'exactmetrics-premium' ),
			'FO' => __( 'Faroe Islands', 'exactmetrics-premium' ),
			'FJ' => __( 'Fiji', 'exactmetrics-premium' ),
			'FI' => __( 'Finland', 'exactmetrics-premium' ),
			'FR' => __( 'France', 'exactmetrics-premium' ),
			'GF' => __( 'French Guiana', 'exactmetrics-premium' ),
			'PF' => __( 'French Polynesia', 'exactmetrics-premium' ),
			'TF' => __( 'French Southern Territories', 'exactmetrics-premium' ),
			'GA' => __( 'Gabon', 'exactmetrics-premium' ),
			'GM' => __( 'Gambia', 'exactmetrics-premium' ),
			'GE' => __( 'Georgia', 'exactmetrics-premium' ),
			'DE' => __( 'Germany', 'exactmetrics-premium' ),
			'GR' => __( 'Greece', 'exactmetrics-premium' ),
			'GH' => __( 'Ghana', 'exactmetrics-premium' ),
			'GI' => __( 'Gibraltar', 'exactmetrics-premium' ),
			'GL' => __( 'Greenland', 'exactmetrics-premium' ),
			'GD' => __( 'Grenada', 'exactmetrics-premium' ),
			'GP' => __( 'Guadeloupe', 'exactmetrics-premium' ),
			'GU' => __( 'Guam', 'exactmetrics-premium' ),
			'GT' => __( 'Guatemala', 'exactmetrics-premium' ),
			'GG' => __( 'Guernsey', 'exactmetrics-premium' ),
			'GN' => __( 'Guinea', 'exactmetrics-premium' ),
			'GW' => __( 'Guinea-Bissau', 'exactmetrics-premium' ),
			'GY' => __( 'Guyana', 'exactmetrics-premium' ),
			'HT' => __( 'Haiti', 'exactmetrics-premium' ),
			'HM' => __( 'Heard and McDonald Islands', 'exactmetrics-premium' ),
			'VA' => __( 'Holy See (City Vatican State)', 'exactmetrics-premium' ),
			'HN' => __( 'Honduras', 'exactmetrics-premium' ),
			'HK' => __( 'Hong Kong', 'exactmetrics-premium' ),
			'HU' => __( 'Hungary', 'exactmetrics-premium' ),
			'IS' => __( 'Iceland', 'exactmetrics-premium' ),
			'IN' => __( 'India', 'exactmetrics-premium' ),
			'ID' => __( 'Indonesia', 'exactmetrics-premium' ),
			'IR' => __( 'Iran', 'exactmetrics-premium' ),
			'IQ' => __( 'Iraq', 'exactmetrics-premium' ),
			'IE' => __( 'Ireland', 'exactmetrics-premium' ),
			'IM' => __( 'Isle of Man', 'exactmetrics-premium' ),
			'IL' => __( 'Israel', 'exactmetrics-premium' ),
			'IT' => __( 'Italy', 'exactmetrics-premium' ),
			'JM' => __( 'Jamaica', 'exactmetrics-premium' ),
			'JP' => __( 'Japan', 'exactmetrics-premium' ),
			'JE' => __( 'Jersey', 'exactmetrics-premium' ),
			'JO' => __( 'Jordan', 'exactmetrics-premium' ),
			'KZ' => __( 'Kazakhstan', 'exactmetrics-premium' ),
			'KE' => __( 'Kenya', 'exactmetrics-premium' ),
			'KI' => __( 'Kiribati', 'exactmetrics-premium' ),
			'KW' => __( 'Kuwait', 'exactmetrics-premium' ),
			'KG' => __( 'Kyrgyzstan', 'exactmetrics-premium' ),
			'LA' => __( 'Lao People\'s Democratic Republic', 'exactmetrics-premium' ),
			'LV' => __( 'Latvia', 'exactmetrics-premium' ),
			'LB' => __( 'Lebanon', 'exactmetrics-premium' ),
			'LS' => __( 'Lesotho', 'exactmetrics-premium' ),
			'LR' => __( 'Liberia', 'exactmetrics-premium' ),
			'LY' => __( 'Libyan Arab Jamahiriya', 'exactmetrics-premium' ),
			'LI' => __( 'Liechtenstein', 'exactmetrics-premium' ),
			'LT' => __( 'Lithuania', 'exactmetrics-premium' ),
			'LU' => __( 'Luxembourg', 'exactmetrics-premium' ),
			'MO' => __( 'Macau', 'exactmetrics-premium' ),
			'MK' => __( 'Macedonia (FYROM)', 'exactmetrics-premium' ),
			'MG' => __( 'Madagascar', 'exactmetrics-premium' ),
			'MW' => __( 'Malawi', 'exactmetrics-premium' ),
			'MY' => __( 'Malaysia', 'exactmetrics-premium' ),
			'MV' => __( 'Maldives', 'exactmetrics-premium' ),
			'ML' => __( 'Mali', 'exactmetrics-premium' ),
			'MT' => __( 'Malta', 'exactmetrics-premium' ),
			'MH' => __( 'Marshall Islands', 'exactmetrics-premium' ),
			'MQ' => __( 'Martinique', 'exactmetrics-premium' ),
			'MR' => __( 'Mauritania', 'exactmetrics-premium' ),
			'MU' => __( 'Mauritius', 'exactmetrics-premium' ),
			'YT' => __( 'Mayotte', 'exactmetrics-premium' ),
			'MX' => __( 'Mexico', 'exactmetrics-premium' ),
			'FM' => __( 'Micronesia', 'exactmetrics-premium' ),
			'MD' => __( 'Moldova, Republic of', 'exactmetrics-premium' ),
			'MC' => __( 'Monaco', 'exactmetrics-premium' ),
			'MN' => __( 'Mongolia', 'exactmetrics-premium' ),
			'ME' => __( 'Montenegro', 'exactmetrics-premium' ),
			'MS' => __( 'Montserrat', 'exactmetrics-premium' ),
			'MA' => __( 'Morocco', 'exactmetrics-premium' ),
			'MZ' => __( 'Mozambique', 'exactmetrics-premium' ),
			'MM' => __( 'Myanmar', 'exactmetrics-premium' ),
			'NA' => __( 'Namibia', 'exactmetrics-premium' ),
			'NR' => __( 'Nauru', 'exactmetrics-premium' ),
			'NP' => __( 'Nepal', 'exactmetrics-premium' ),
			'NL' => __( 'Netherlands', 'exactmetrics-premium' ),
			'AN' => __( 'Netherlands Antilles', 'exactmetrics-premium' ),
			'NC' => __( 'New Caledonia', 'exactmetrics-premium' ),
			'NZ' => __( 'New Zealand', 'exactmetrics-premium' ),
			'NI' => __( 'Nicaragua', 'exactmetrics-premium' ),
			'NE' => __( 'Niger', 'exactmetrics-premium' ),
			'NG' => __( 'Nigeria', 'exactmetrics-premium' ),
			'NU' => __( 'Niue', 'exactmetrics-premium' ),
			'NF' => __( 'Norfolk Island', 'exactmetrics-premium' ),
			'KP' => __( 'North Korea', 'exactmetrics-premium' ),
			'MP' => __( 'Northern Mariana Islands', 'exactmetrics-premium' ),
			'NO' => __( 'Norway', 'exactmetrics-premium' ),
			'OM' => __( 'Oman', 'exactmetrics-premium' ),
			'PK' => __( 'Pakistan', 'exactmetrics-premium' ),
			'PW' => __( 'Palau', 'exactmetrics-premium' ),
			'PS' => __( 'Palestinian Territories', 'exactmetrics-premium' ),
			'PA' => __( 'Panama', 'exactmetrics-premium' ),
			'PG' => __( 'Papua New Guinea', 'exactmetrics-premium' ),
			'PY' => __( 'Paraguay', 'exactmetrics-premium' ),
			'PE' => __( 'Peru', 'exactmetrics-premium' ),
			'PH' => __( 'Philippines', 'exactmetrics-premium' ),
			'PN' => __( 'Pitcairn Island', 'exactmetrics-premium' ),
			'PL' => __( 'Poland', 'exactmetrics-premium' ),
			'PT' => __( 'Portugal', 'exactmetrics-premium' ),
			'PR' => __( 'Puerto Rico', 'exactmetrics-premium' ),
			'QA' => __( 'Qatar', 'exactmetrics-premium' ),
			'XK' => __( 'Republic of Kosovo', 'exactmetrics-premium' ),
			'RE' => __( 'Reunion Island', 'exactmetrics-premium' ),
			'RO' => __( 'Romania', 'exactmetrics-premium' ),
			'RU' => __( 'Russian Federation', 'exactmetrics-premium' ),
			'RW' => __( 'Rwanda', 'exactmetrics-premium' ),
			'BL' => __( 'Saint Barth&eacute;lemy', 'exactmetrics-premium' ),
			'SH' => __( 'Saint Helena', 'exactmetrics-premium' ),
			'KN' => __( 'Saint Kitts and Nevis', 'exactmetrics-premium' ),
			'LC' => __( 'Saint Lucia', 'exactmetrics-premium' ),
			'MF' => __( 'Saint Martin (French)', 'exactmetrics-premium' ),
			'SX' => __( 'Saint Martin (Dutch)', 'exactmetrics-premium' ),
			'PM' => __( 'Saint Pierre and Miquelon', 'exactmetrics-premium' ),
			'VC' => __( 'Saint Vincent and the Grenadines', 'exactmetrics-premium' ),
			'SM' => __( 'San Marino', 'exactmetrics-premium' ),
			'ST' => __( 'S&atilde;o Tom&eacute; and Pr&iacute;ncipe', 'exactmetrics-premium' ),
			'SA' => __( 'Saudi Arabia', 'exactmetrics-premium' ),
			'SN' => __( 'Senegal', 'exactmetrics-premium' ),
			'RS' => __( 'Serbia', 'exactmetrics-premium' ),
			'SC' => __( 'Seychelles', 'exactmetrics-premium' ),
			'SL' => __( 'Sierra Leone', 'exactmetrics-premium' ),
			'SG' => __( 'Singapore', 'exactmetrics-premium' ),
			'SK' => __( 'Slovak Republic', 'exactmetrics-premium' ),
			'SI' => __( 'Slovenia', 'exactmetrics-premium' ),
			'SB' => __( 'Solomon Islands', 'exactmetrics-premium' ),
			'SO' => __( 'Somalia', 'exactmetrics-premium' ),
			'ZA' => __( 'South Africa', 'exactmetrics-premium' ),
			'GS' => __( 'South Georgia', 'exactmetrics-premium' ),
			'KR' => __( 'South Korea', 'exactmetrics-premium' ),
			'SS' => __( 'South Sudan', 'exactmetrics-premium' ),
			'ES' => __( 'Spain', 'exactmetrics-premium' ),
			'LK' => __( 'Sri Lanka', 'exactmetrics-premium' ),
			'SD' => __( 'Sudan', 'exactmetrics-premium' ),
			'SR' => __( 'Suriname', 'exactmetrics-premium' ),
			'SJ' => __( 'Svalbard and Jan Mayen Islands', 'exactmetrics-premium' ),
			'SZ' => __( 'Swaziland', 'exactmetrics-premium' ),
			'SE' => __( 'Sweden', 'exactmetrics-premium' ),
			'CH' => __( 'Switzerland', 'exactmetrics-premium' ),
			'SY' => __( 'Syrian Arab Republic', 'exactmetrics-premium' ),
			'TW' => __( 'Taiwan', 'exactmetrics-premium' ),
			'TJ' => __( 'Tajikistan', 'exactmetrics-premium' ),
			'TZ' => __( 'Tanzania', 'exactmetrics-premium' ),
			'TH' => __( 'Thailand', 'exactmetrics-premium' ),
			'TL' => __( 'Timor-Leste', 'exactmetrics-premium' ),
			'TG' => __( 'Togo', 'exactmetrics-premium' ),
			'TK' => __( 'Tokelau', 'exactmetrics-premium' ),
			'TO' => __( 'Tonga', 'exactmetrics-premium' ),
			'TT' => __( 'Trinidad and Tobago', 'exactmetrics-premium' ),
			'TN' => __( 'Tunisia', 'exactmetrics-premium' ),
			'TR' => __( 'Turkey', 'exactmetrics-premium' ),
			'TM' => __( 'Turkmenistan', 'exactmetrics-premium' ),
			'TC' => __( 'Turks and Caicos Islands', 'exactmetrics-premium' ),
			'TV' => __( 'Tuvalu', 'exactmetrics-premium' ),
			'UG' => __( 'Uganda', 'exactmetrics-premium' ),
			'UA' => __( 'Ukraine', 'exactmetrics-premium' ),
			'AE' => __( 'United Arab Emirates', 'exactmetrics-premium' ),
			'UY' => __( 'Uruguay', 'exactmetrics-premium' ),
			'UM' => __( 'US Minor Outlying Islands', 'exactmetrics-premium' ),
			'UZ' => __( 'Uzbekistan', 'exactmetrics-premium' ),
			'VU' => __( 'Vanuatu', 'exactmetrics-premium' ),
			'VE' => __( 'Venezuela', 'exactmetrics-premium' ),
			'VN' => __( 'Vietnam', 'exactmetrics-premium' ),
			'VG' => __( 'Virgin Islands (British)', 'exactmetrics-premium' ),
			'VI' => __( 'Virgin Islands (USA)', 'exactmetrics-premium' ),
			'WF' => __( 'Wallis and Futuna Islands', 'exactmetrics-premium' ),
			'EH' => __( 'Western Sahara', 'exactmetrics-premium' ),
			'WS' => __( 'Western Samoa', 'exactmetrics-premium' ),
			'YE' => __( 'Yemen', 'exactmetrics-premium' ),
			'ZM' => __( 'Zambia', 'exactmetrics-premium' ),
			'ZW' => __( 'Zimbabwe', 'exactmetrics-premium' ),
			'ZZ' => __( 'Unknown Country', 'exactmetrics-premium' ),
		);
	} else {
		$countries = array(
			''   => '',
...
function exactmetrics_detect_tracking_code_error( $body ) {
	...
	$cache_error = sprintf(
		esc_html__( '%1$sWe noticed you\'re using a caching plugin or caching from your hosting provider.%2$s Be sure to clear the cache to ensure the tracking appears on all pages and posts. %3$s(See this guide on how to clear cache)%4$s.', 'exactmetrics-premium' ),
		'<b>',
		'</b>',
	...
	if ( $total_count > $limit ) {
		...
		$message           = esc_html__( '%1$sWe have detected multiple tracking codes%2$s! You should remove non-ExactMetrics ones. If you need help finding them please %3$sread this article%4$s.', 'exactmetrics-premium' );
...
function exactmetrics_get_english_speaking_countries() {
	return array(
		...
		'RW' => __( 'Rwanda', 'exactmetrics-premium' ),
		'SG' => __( 'Singapore', 'exactmetrics-premium' ),
		'KN' => __( 'St Kitts and Nevis', 'exactmetrics-premium' ),
		'LC' => __( 'St Lucia', 'exactmetrics-premium' ),
		'VC' => __( 'St Vincent and the Grenadines', 'exactmetrics-premium' ),
		'SZ' => __( 'Swaziland', 'exactmetrics-premium' ),
		'WS' => __( 'Samoa', 'exactmetrics-premium' ),
		'SC' => __( 'Seychelles', 'exactmetrics-premium' ),
		'SL' => __( 'Sierra Leone', 'exactmetrics-premium' ),
		'SB' => __( 'Solomon Islands', 'exactmetrics-premium' ),
		'ZA' => __( 'South Africa', 'exactmetrics-premium' ),
		...
		'SD' => __( 'Sudan', 'exactmetrics-premium' ),
		'TT' => __( 'Trinidad and Tobago', 'exactmetrics-premium' ),
		'BS' => __( 'The Bahamas', 'exactmetrics-premium' ),
		'TZ' => __( 'Tanzania', 'exactmetrics-premium' ),
		'TO' => __( 'Tonga', 'exactmetrics-premium' ),
		'TV' => __( 'Tuvalu', 'exactmetrics-premium' ),
		'GB' => __( 'United Kingdom', 'exactmetrics-premium' ),
		'US' => __( 'United States of America', 'exactmetrics-premium' ),
		'UG' => __( 'Uganda', 'exactmetrics-premium' ),
		'VU' => __( 'Vanuatu', 'exactmetrics-premium' ),
		'ZM' => __( 'Zambia', 'exactmetrics-premium' ),
		'ZW' => __( 'Zimbabwe', 'exactmetrics-premium' ),
