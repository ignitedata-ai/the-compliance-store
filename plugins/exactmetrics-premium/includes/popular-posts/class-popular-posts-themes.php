...
class ExactMetrics_Popular_Posts_Themes {
	...
	public function get_themes_inline() {
		...
		$themes = array(
			'alpha'    => array(
				'label'  => __( 'Alpha', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393F4C',
						'size'  => 18,
						'text'  => __( '15 Proven Ways to Repurpose Content on Your WordPress Site', 'exactmetrics-premium' ),
					),
					'label'      => array(
						'color' => '#EB5757',
						'text'  => __( 'Trending', 'exactmetrics-premium' ),
					),
					'background' => array(
						'color' => '#F0F2F4',
					),
			...
			'beta'     => array(
				'label'  => __( 'Beta', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393F4C',
						'size'  => 18,
						'text'  => __( 'How to Use Google Trends to Boost Traffic and Sales (9 Simple Ways)', 'exactmetrics-premium' ),
					),
					'label'      => array(
						'color' => '#EB5757',
						'text'  => __( 'Trending', 'exactmetrics-premium' ),
			...
			'charlie'  => array(
				'label'  => __( 'Charlie', 'exactmetrics-premium' ),
				'styles' => array(
					'title'  => array(
						'color' => '#393f4c',
						'size'  => 16,
					...
					'label'  => array(
						'color' => '#393f4c',
						'text'  => __( 'Popular Stories Right now', 'exactmetrics-premium' ),
					),
					'border' => array(
						'color' => '#D3D7DE',
					),
				...
				'list'   => array(
					__( '15 Proven Ways to Repurpose Content on Your WordPress Site', 'exactmetrics-premium' ),
					__( 'How to Use Google Trends to Boost Traffic and Sales (9 Simple Ways)', 'exactmetrics-premium' ),
					__( 'How to Set Up Online Ordering for Your Restaurant Website', 'exactmetrics-premium' ),
				),
				'posts'  => 3,
				'level'  => 'lite',
			),
			'delta'    => array(
				'label'  => __( 'Delta', 'exactmetrics-premium' ),
				'styles' => array(
					'icon'       => array(
						'color' => '#EB5757',
					),
			...
			'echo'     => array(
				'label'  => __( 'Echo', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'foxtrot'  => array(
				'label'  => __( 'Foxtrot', 'exactmetrics-premium' ),
				'styles' => array(
					'title' => array(
						'color' => '#393f4c',
						'size'  => 18,
						'text'  => __( 'How to Build an Email List in WordPress – Email Marketing 101', 'exactmetrics-premium' ),
					),
					'label' => array(
						'color' => '#EB5757',
						'text'  => __( 'Trending', 'exactmetrics-premium' ),
			...
			'golf'     => array(
				'label'  => __( 'Golf', 'exactmetrics-premium' ),
				'styles' => array(
					'title'  => array(
						'color' => '#393f4c',
						'size'  => 16,
					...
					'label'  => array(
						'color' => '#EB5757',
						'text'  => __( 'Popular now', 'exactmetrics-premium' ),
					),
					'border' => array(
						'color'  => '#EB5757',
						'color2' => '#E2E4E9',
			...
			'hotel'    => array(
				'label'  => __( 'Hotel', 'exactmetrics-premium' ),
				'styles' => array(
					'title' => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'india'    => array(
				'label'  => __( 'India', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393f4c',
						'size'  => 14,
			...
			'juliett'  => array(
				'label'  => __( 'Juliett', 'exactmetrics-premium' ),
				'styles' => array(
					'title'  => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'kilo'     => array(
				'label'  => __( 'Kilo', 'exactmetrics-premium' ),
				'styles' => array(
					'title'  => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'lima'     => array(
				'label'  => __( 'Lima', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'mike'     => array(
				'label'  => __( 'Mike', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393f4c',
						'size'  => 18,
			...
			'november' => array(
				'label'  => __( 'November', 'exactmetrics-premium' ),
				'styles' => array(
					'title'      => array(
						'color' => '#393f4c',
						'size'  => 16,
	...
	public function get_themes_widget() {
		...
		$themes = array(
			'alpha'   => array(
				...
				'list'   => array(
					'items' => array(
						__( 'How to Set Up WordPress User Activity Tracking in 3 Easy Steps', 'exactmetrics-premium' ),
						__( 'How to Share Your Google Analytics Reports with Others (5 Easy Ways)', 'exactmetrics-premium' ),
						__( '12 Best Social Media Analytics Tools for Marketers (Tried & Tested)', 'exactmetrics-premium' ),
						__( '9 Proven Ways to Get Google to Index Your Website Right Away', 'exactmetrics-premium' ),
					),
				),
				'level'  => 'lite',
			),
			'beta'    => array(
				...
				'list'   => array(
					'items' => array(
						...
						__( 'How to Share Your Google Analytics Reports with Others (5 Easy Ways)', 'exactmetrics-premium' ),
						__( '12 Best Social Media Analytics Tools for Marketers (Tried & Tested)', 'exactmetrics-premium' ),
						__( 'Uncover How Much Traffic Does a Website Get (5 Effortless Ways)', 'exactmetrics-premium' ),
					),
				),
				'level'  => 'lite',
			),
			...
			'hotel'   => array(
				...
				'list'   => array(
					'items'  => array(
						__( 'How to Allow WordPress to Upload All File Types (The Easy Way)', 'exactmetrics-premium' ),
						__( '14 Handy Google Search Operators for SEO (A Complete List)', 'exactmetrics-premium' ),
						__( 'How to Write Irresistible Meta Descriptions for SEO & More Clicks?', 'exactmetrics-premium' ),
						__( 'Uncover How Much Traffic Does a Website Get (5 Effortless Ways)', 'exactmetrics-premium' ),
					),
					'images' => array(
						'theme-widget-5.jpg',
	...
	public function get_themes_products() {
		$themes = array(
			'alpha'   => array(
				...
				'list'   => array(
					'items'  => array(
						__( 'WPBeginner 10-Year Anniversary Gray T-Shirt', 'exactmetrics-premium' ),
						__( 'WPForms Small White Logo T-Shirt', 'exactmetrics-premium' ),
						__( 'OptinMonster White Text Color Mascot T-Shirt', 'exactmetrics-premium' ),
						__( 'WPForms Make Things Simple Gray T-Shirt', 'exactmetrics-premium' ),
					),
					'images' => array(
			...
			'beta'    => array(
				...
				'list'   => array(
					'items'  => array(
						__( 'Admin WPBeginner Black T-Shirt', 'exactmetrics-premium' ),
						__( 'Black WP Beginner logo T-Shirt', 'exactmetrics-premium' ),
						__( 'Technically Awesome Groovy White T-Shirt', 'exactmetrics-premium' ),
						__( 'Technically Awesome Code Comment Black T-Shirt', 'exactmetrics-premium' ),
					),
					'images' => array(
