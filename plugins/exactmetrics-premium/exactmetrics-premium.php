...
final class ExactMetrics {
	...
	public static function get_instance() {
		...
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof ExactMetrics ) ) {
			...
			_exactmetrics_check_deprecated_addons();
 ...
 * @since 7.18
 */
function exactmetrics_deactivation_hook() {
	wp_clear_scheduled_hook( 'exactmetrics_usage_tracking_cron' );
	wp_clear_scheduled_hook( 'exactmetrics_email_summaries_cron' );
	wp_clear_scheduled_hook( 'exactmetrics_ai_insights_checkin' );
	wp_clear_scheduled_hook( 'exactmetrics_charitable_notice_cron' );
}

register_deactivation_hook( __FILE__, 'exactmetrics_deactivation_hook' );
