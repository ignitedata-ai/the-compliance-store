<?php
/**
 * ExactMetrics Divi Image Module
 */

class ExactMetrics_Divi_Image_Module extends ET_Builder_Module_Image {
	function init() {
		$this->name       = 'ExactMetrics Image';
		$this->plural     = 'ExactMetrics Images';
		$this->slug       = 'exactmetrics_divi_image_module';
		...
		$this->settings_modal_toggles = array(
			...
			'custom_css' => array(
				'toggles' => array(
					...
					'exactmetrics_advanced_toggle' => array(
						'title'    => 'ExactMetrics',
						'priority' => 250,
					),
				),
	...
	public function get_fields() {
		...
		$fields['exactmetrics_mark_as_conversion_event'] = array(
			'label' => 'ExactMetrics Mark as Conversion Event',
			...
			'tab_slug' => 'custom_css',
			'toggle_slug' => 'exactmetrics_advanced_toggle',
			'affects'          => array(
		...
		$fields['exactmetrics_custom_event_name'] = array(
			'label' => 'ExactMetrics Custom Event Name',
			'type' => 'text',
		...
		$fields['exactmetrics_mark_as_key_event'] = array(
			'label' => 'ExactMetrics Mark as Key Event',
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( empty( $attrs['exactmetrics_mark_as_conversion_event'] ) ) {
			return $output;
		}

		$mark_as_conversion_event = $this->props['exactmetrics_mark_as_conversion_event'];

		if ( empty( $attrs['exactmetrics_mark_as_key_event'] ) ) {
			...
			$custom_event_name = trim( (string) $this->props['exactmetrics_custom_event_name'] );
		}
