...
final class ExactMetrics_Report_Traffic_Campaign extends ExactMetrics_Report {

	public $class = 'ExactMetrics_Report_Traffic_Campaign';
	...
	public function __construct() {
		$this->title = __( 'Traffic Campaigns', 'exactmetrics-premium' );
