...
final class ExactMetrics_Report_Cart_Abandonment extends ExactMetrics_Report {

	public $class = 'ExactMetrics_Report_Cart_Abandonment';
	...
	public function requirements( $error = false, $args = array(), $name = '' ) {
		...
		if ( ! class_exists( 'ExactMetrics_eCommerce' ) ) {
			...
			$text = __( 'Please %s the ExactMetrics eCommerce addon to view Cart Abandonment reports.', 'ga-premium' );
