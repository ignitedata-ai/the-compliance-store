...
final class ExactMetrics_Notification_To_Track_Form_Submission extends ExactMetrics_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$forms_addon_active = class_exists( 'ExactMetrics_Forms' );
		...
		if ( ! $forms_addon_active ) {
			...
			$notification['content'] = __( 'Enable form tracking by enabling our Forms addon', 'exactmetrics-premium' );

			$notification['btns'] = array(
				"activate_addon" => array(
					'url'  => $this->get_view_url( 'exactmetrics-addon-forms', 'exactmetrics_settings', 'addons' ),
