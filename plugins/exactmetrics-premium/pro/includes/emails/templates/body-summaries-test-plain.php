...
echo esc_html__( 'Total Visitors', 'exactmetrics-premium' ) . '   -   ' . esc_html( number_format_i18n( '484000' ) ) . "\n";
echo esc_html__( 'Increase Visitors 13%', 'exactmetrics-premium' ) . "\n\n";

echo esc_html__( 'Total Pageviews', 'exactmetrics-premium' ) . '   -   ' . esc_html( number_format_i18n( '1800000' ) ) . "\n";
