	...
	class Notifications {
		...
		public static function content_show() {
			...
			if ( ! \wsal_freemius()->is_free_plan() ) {
				...
				$settings_tabs['custom-notifications']      = array(
					'icon'  => 'table-row-after',
					'title' => \esc_html__( 'Custom notifications', 'wp-security-audit-log' ),
				);
				$settings_tabs['notification-settings']     = array(
					'icon'  => 'admin-generic',
					'title' => \esc_html__( 'Notification settings', 'wp-security-audit-log' ),
				);
				$settings_tabs['custom-notification-edit']  = array(
					'icon'  => 'admin-generic',
