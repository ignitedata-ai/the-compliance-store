    ...
    class Faulh_DB_Helper {
        ...
        static public function all_columns() {
            $columns = array(
                ...
                'username_csv' => esc_html__('Email', 'faulh'),
                'name' => esc_html__('Name', 'faulh'),
                'role' => esc_html__('Role', 'faulh'),
                
                'status' => esc_html__('Status', 'faulh'),
                't_t_status' => esc_html__('T&T Access', 'faulh'),
                'p_p_status' => esc_html__('P&P Access', 'faulh'),
                
                
                //'old_role' => "<span title='" . esc_attr__('Role while user gets logged in', 'faulh') . "'>" . esc_html__('Old Role (?)', 'faulh') . "</span>",
                'business_table' => esc_html__('Business', 'faulh'),
                'corporate_table' => esc_html__('Corporate Facility', 'faulh'),
                'facility_table' => esc_html__('Admin Facility', 'faulh'),
                'account_manager_table' => esc_html__('Account Manager', 'faulh'),
                ...
                'browser' => esc_html__('Web Browser', 'faulh'),
