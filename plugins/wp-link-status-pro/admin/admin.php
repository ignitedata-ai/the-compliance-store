...
class WPLNST_Admin extends WPLNST_Core_Module {
	...
	public function admin_enqueue() {
		...
		// Edit scan script
		if (WPLNST_Core_Plugin::slug == $_GET['page'] && WPLNST_Core_Plugin::slug.'-new-scan' == $_GET['action'] || (!empty($_GET['context']) && 'edit' == $_GET['context'])) {
	...
	public function admin_menu() {
		...
		// Scans
		add_submenu_page('views-reports', 'Broken Links', 'Broken Links', WPLNST_Core_Plugin::capability, WPLNST_Core_Plugin::slug, array(&$this, 'link_checker_scans'));
	...
	private function scans_edit_submit_check() {
		...
		if ((WPLNST_Core_Plugin::slug == $_GET['page'] && !empty($_GET['context']) && 'edit' == $_GET['context']) || WPLNST_Core_Plugin::slug == $_GET['page'] && WPLNST_Core_Plugin::slug.'-new-scan' == $_GET['action']) {
